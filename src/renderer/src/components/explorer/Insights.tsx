...
export function Insights({ insights }: InsightsProps): JSX.Element {
  ...
  const height = isOnline && insights ? insights.height.toLocaleString() : t('explorer.insights.offline')
    ...
    <div className="grid grid-cols-5 gap-4">
      <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-xs font-semibold text-slate-600">{t('explorer.insights.chainHeight')}</span>
        </div>
        <p className="text-xl font-bold text-slate-800">{height}</p>
        <p className="text-[10px] text-slate-400 mt-0.5">{t('explorer.insights.latest')}</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-xs font-semibold text-slate-600">{t('explorer.insights.blockTime')}</span>
        </div>
        <p className="text-xl font-bold text-slate-800">{blockTime}</p>
        <p className="text-[10px] text-slate-400 mt-0.5">{t('explorer.insights.past100')}</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-xs font-semibold text-slate-600">{t('explorer.insights.transactions')}</span>
        </div>
        <p className="text-xl font-bold text-slate-800">{txs}</p>
        <p className="text-[10px] text-slate-400 mt-0.5">{t('explorer.insights.estPast12')}</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-xs font-semibold text-slate-600">{t('explorer.insights.activeAddrs')}</span>
        </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-xs font-semibold text-slate-600">{t('explorer.insights.difficulty')}</span>
        </div>
        <p className="text-xl font-bold text-slate-800">{diff}</p>
        <p className="text-[10px] text-slate-400 mt-0.5">{t('explorer.insights.current')}</p>
      </div>
    </div>
  )
}
