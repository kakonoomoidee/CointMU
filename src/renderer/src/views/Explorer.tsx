                            ...
                            >
                              <td className="px-5 py-3.5">
                                <p
                                  ...
                                  onClick={() =>
                                    handleBlockSelect(block.number)
                                  }
                                >
                                  #{block.number}
                                </p>
                          ...
                          <tr>
                            <td colSpan={5} className="px-5 py-12 text-center">
                              ...
                              <p className="text-xs text-slate-400 mt-1">
                                Block data requires an indexer
                              </p>
                            </td>
                          </tr>
                        )}
                        ...
                        {isLoadingAccounts ? (
                          ...
                          <tr>
                            <td colSpan={5} className="px-5 py-12 text-center">
                              ...
                              <p className="text-xs text-slate-400 mt-1">
                                Account data requires an indexer or active
                                network
                              </p>
                            </td>
                          </tr>
                  ...
                  {MINER_DISTRIBUTION.length > 0 ? (
                    ...
                    <div className="py-8 flex flex-col items-center justify-center text-center">
                      ...
                      <p className="text-xs text-slate-400 mt-0.5">
                        Distribution requires an indexer
                      </p>
                    </div>
                  )}
                </div>
          ...
          <div className="max-w-5xl mx-auto space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between pb-4 border-b border-slate-100">
                    ...
                    <span className="text-sm text-slate-800 text-right">
                      {new Date(
                        parseInt(selectedBlock.timestamp, 16) * 1000,
                      ).toLocaleString()}
                    </span>
                  </div>
                  <div className="flex items-center justify-between pb-4 border-b border-slate-100">
                  ...
                  <div className="flex items-center justify-between pb-4 border-b border-slate-100">
                    ...
                    <span className="text-sm font-mono text-slate-800 text-right">
                      {parseInt(selectedBlock.nonce, 16).toLocaleString()}
                    </span>
                  </div>
                  <div className="flex items-center justify-between pb-4 border-b border-slate-100">
                    <span className="text-xs font-semibold text-slate-500 w-1/3">
                    ...
                    <span className="text-sm font-mono text-slate-800 text-right">
                      {parseInt(selectedBlock.difficulty, 16).toLocaleString()}
                    </span>
                  </div>
                  <div className="flex items-center justify-between pb-4 border-b border-slate-100">
                    <span className="text-xs font-semibold text-slate-500 w-1/3">
                    ...
                    <span className="text-sm font-mono text-slate-800 text-right">
                      {parseInt(selectedBlock.size, 16).toLocaleString()} bytes
                    </span>
                  </div>
                  <div className="flex items-center justify-between pb-4 border-b border-slate-100">
                    <span className="text-xs font-semibold text-slate-500 w-1/3">
                    ...
                    <span className="text-sm font-mono text-slate-800 text-right">
                      {selectedBlock.transactions?.length || 0} transactions
                    </span>
                  </div>
                  <div className="flex items-center justify-between pb-4 border-b border-slate-100">
                    <span className="text-xs font-semibold text-slate-500 w-1/3">
                ...
                <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm flex-1">
                  ...
                  <div className="flex flex-col gap-3">
                    {[
                      ...
                      const isCurrent =
                        num === parseInt(selectedBlock.number, 16);
                      return (
                        <div
                          key={num}
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
              ...
              <p className="text-[10px] text-slate-400 mb-5">
                {selectedBlock.transactions?.length || 0} entries
              </p>
            ...
            <div className="flex items-center gap-4">
              <button
                onClick={() => {
                  if (
                    selectedBlock &&
                    selectedBlock.number === selectedTx.blockNumber
                  ) {
                    setCurrentView("BLOCK_DETAIL");
                  } else {
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
              <div className="space-y-4">
                <div className="flex items-center pb-4 border-b border-slate-100">
                  <span className="text-xs font-semibold text-slate-500 w-1/4">
                    Transaction hash:
                  </span>
                ...
                <div className="flex items-center pb-4 border-b border-slate-100">
                  ...
                  <span className="text-sm text-slate-800">
                    {(
                      (parseInt(selectedTx.gas, 16) *
                        parseInt(selectedTx.gasPrice, 16)) /
                      1e18
                    ).toFixed(6)}{" "}
                    CMU
                  </span>
                ...
                <div className="flex items-center pb-4 border-b border-slate-100">
                  ...
                  <span className="text-sm text-slate-800">
                    {parseInt(selectedTx.nonce, 16)}
                  </span>
                </div>
                <div className="flex items-start">
                  <span className="text-xs font-semibold text-slate-500 w-1/4 pt-1">
                    Input data:
                  </span>
