        ...
        <section>
          ...
          <div className="bg-white border border-slate-200 rounded-xl divide-y divide-slate-100 shadow-sm">
            ...
            <div className="flex items-center justify-between p-4">
              ...
              <button
                onClick={() =>
                  onUpdate("showSidebarColors", !config.showSidebarColors)
                }
              ...
              >
                <div
                  className={`w-5 h-5 bg-white rounded-full shadow-sm transform transition-transform ${config.showSidebarColors ? "translate-x-5" : "translate-x-0"}`}
                />
              </button>
            </div>
            ...
            <div className="flex items-center justify-between p-4">
              ...
              <button
                onClick={() =>
                  onUpdate("animatedTransitions", !config.animatedTransitions)
                }
              ...
              >
                <div
                  className={`w-5 h-5 bg-white rounded-full shadow-sm transform transition-transform ${config.animatedTransitions ? "translate-x-5" : "translate-x-0"}`}
                />
              </button>
            </div>
          </div>
