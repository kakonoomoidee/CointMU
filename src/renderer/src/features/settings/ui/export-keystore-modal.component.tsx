 ...
 */
export function ExportKeystoreModal({
  onClose,
}: ExportKeystoreModalProps): JSX.Element {
  ...
  const handleExport = async (event: SyntheticEvent): Promise<void> => {
    event.preventDefault();
    setError("");
    const account =
      accounts.find((a) => a.address === activeAccount) ??
